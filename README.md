## Конфигурация для создания и запуска Docker-контейнеров для приложения отслеживания погодных явлений
...
3. Для сборки используйте команду: docker compose up (docker-compose up -d)
